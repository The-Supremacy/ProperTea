...
namespace ProperTea.Organization.Core.Migrations
{
    ...
    [Migration("20251128081725_Wolverine")]
    partial class Wolverine
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Wolverine.EntityFrameworkCore.Internals.IncomingMessage", b =>
                {
                    ...
                    b.ToTable("wolverine_incoming_envelopes", "organization", t =>
                        {
            ...
            modelBuilder.Entity("Wolverine.EntityFrameworkCore.Internals.OutgoingMessage", b =>
                {
                    ...
                    b.ToTable("wolverine_outgoing_envelopes", "organization", t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
