...
This documentation suite provides comprehensive guidance for developing, deploying, and maintaining the ProperTea
microservices platform. All documents are designed to be both **human-readable** and **AI-assistant friendly** for
...
- Patterns and
  libraries: [03-event-driven-patterns.md](./03-event-driven-patterns.md), [04-shared-libraries.md](./04-shared-libraries.md)
...
3. Create Contact GDPR deletion
   saga: [03-event-driven-patterns.md](./03-event-driven-patterns.md#saga-orchestration-pattern)
...
See [09-local-development.md#troubleshooting](./09-local-development.md#troubleshooting) for common issues and
solutions.
...
- [SESSION-2025-10-29-PART2.md](./SESSION-2025-10-29-PART2.md) - Storage strategy, observability, JWT optimization,
  contact ownership, AKS deployment
