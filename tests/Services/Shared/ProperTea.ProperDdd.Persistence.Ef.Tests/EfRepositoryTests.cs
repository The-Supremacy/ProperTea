...
public class EfRepositoryTests
{
    ...
    [Fact]
    public async Task AddAsync_ShouldAddAggregateToDatabase()
    {
        // Arrange
    ...
    [Fact]
    public async Task GetByIdAsync_ShouldReturnCorrectAggregate()
    {
        // Arrange
    ...
    [Fact]
    public async Task Update_ShouldModifyAggregateInDatabase()
    {
        // Arrange
        var (repository, context) = await GetRepositoryAsync();
    ...
    [Fact]
    public async Task Delete_ShouldRemoveAggregateFromDatabase()
    {
        // Arrange
        var (repository, context) = await GetRepositoryAsync();
