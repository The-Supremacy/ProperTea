...
namespace ProperTea.ProperIntegrationEvents.Outbox.UnitTests;
...
public class IntegrationEventsOutboxProcessorTests
{
    ...
    [Fact]
    public async Task ProcessOutboxMessagesAsync_NoMessagesToProcess_DoesNothing()
    {
        // Arrange
    ...
    [Fact]
    public async Task ProcessOutboxMessagesAsync_WithMessagesToProcess_PublishesAndMarksAsProcessed()
    {
        // Arrange
    ...
    [Fact]
    public async Task ProcessOutboxMessagesAsync_WhenTypeResolutionFails_MarksMessageAsFailed()
    {
        // Arrange
