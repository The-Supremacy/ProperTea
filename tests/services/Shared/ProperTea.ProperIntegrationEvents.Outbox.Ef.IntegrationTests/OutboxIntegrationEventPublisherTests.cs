...
namespace ProperTea.ProperIntegrationEvents.Outbox.Ef.IntegrationTests;
...
public class OutboxIntegrationEventPublisherTests : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        services.AddTransient<IIntegrationEventPublisher, DbContextOutboxMessagesService>();

        services.AddProperIntegrationEvents()
            .AddOutbox(o => o.AddEntityFrameworkStores<TestDbContext>());
