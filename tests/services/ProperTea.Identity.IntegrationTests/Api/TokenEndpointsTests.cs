...
public class TokenEndpointsTests(IdentityServiceFactory factory) : IClassFixture<IdentityServiceFactory>
{
    private readonly HttpClient _client = factory.CreateClient();
    private readonly IdentityServiceFactory _factory = factory;
