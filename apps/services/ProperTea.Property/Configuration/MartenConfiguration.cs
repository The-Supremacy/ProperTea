...
public static class MartenConfiguration
{
        ...
        IHostEnvironment environment)
    {
        ...
        {
            var connectionString = configuration.GetConnectionString("property-db")
                ?? throw new InvalidOperationException("Connection string 'property-db' not found");
            ...
            opts.DatabaseSchemaName = "property";
